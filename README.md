...
受 Open-Meteo 免费层配额 + 服务端并发限流影响，本批次完成 **80.8%**（9,266 / 11,475 块）。

各区域完成度（满值 675 块 = 3模型 × 5要素组 × 45时段块）：

| 区域 | 完成 | 区域 | 完成 |
|---|---|---|---|
| 济南 青岛 淄博 枣庄 东营 | **675（完整）** | 泰安 | 504 |
| 烟台 | 641 | 威海 | 519 |
| 潍坊 | 648 | 日照 | 407 |
| 济宁 | 645 | **临沂** | 203 |
| 聊城 滨州 菏泽 | ~520 | 德州 | 395 |
...
| 覆盖率 | 行数 | 占比 |
|---|---|---|
| **100%（16站点齐全）** | **3,864** | **29.6%** |
| 85–99% | 1,082 | 8.3% |
| < 85% | 8,101 | 62.1% |

**`usable == 1`（覆盖率≥85%）共 4,508 行（34.6%）** —— 建议先用这部分。

仍存在的缺口：
- **临沂（10.89%）仅完成 203/675** —— 鲁南气候偏暖湿，缺口会低估南部
- **德州（6.56%）仅完成 395/675**
- 其余地市有零散缺口
